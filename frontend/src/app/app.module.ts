...
import { RelatorioViagensComponent } from './pages/relatorios/relatorio-viagens/relatorio-viagens.component';
...
const routes: Routes = [
  ...
  { path: 'relatorios/viagens', component: RelatorioViagensComponent },
